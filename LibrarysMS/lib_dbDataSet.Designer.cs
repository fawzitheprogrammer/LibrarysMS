...
namespace LibrarysMS.lib_dbDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([BookID] = @Original_BookID) AND ((@IsNull_Titl" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Books] SET [Title] = @Title WHERE (([BookID] = @Original_BookID) AN" +
                "D ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)));\r\nSE" +
                "LECT BookID, Title FROM Books WHERE (BookID = @BookID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BookID, Title FROM dbo.Books";
        ...
        public virtual int Fill(lib_dbDataSet.BooksDataTable dataTable) {
        ...
        public virtual lib_dbDataSet.BooksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            lib_dbDataSet.BooksDataTable dataTable = new lib_dbDataSet.BooksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(lib_dbDataSet.BooksDataTable dataTable) {
        ...
        public virtual int Delete(int Original_BookID, string Original_Title) {
        ...
        public virtual int Update(string Title, int Original_BookID, string Original_Title, int BookID) {
            if ((Title == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, int Original_BookID, string Original_Title) {
            return this.Update(Title, Original_BookID, Original_Title, Original_BookID);
        }
    }
